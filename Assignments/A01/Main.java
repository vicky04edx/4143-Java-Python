    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // One real root (repeated root)
                ...
                double x = -b / (2.0 * a);   // use 2.0 to ensure double division
                System.out.printf("x = %.2f%n", x);
            }

            // Two distinct real roots
            else {
                double x1 = (-b + Math.sqrt(resultDiscriminant)) / (2.0 * a); 
                double x2 = (-b - Math.sqrt(resultDiscriminant)) / (2.0 * a);
